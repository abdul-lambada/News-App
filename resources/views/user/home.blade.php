...
@section('content')
    <div class="w-full mx-auto px-4 sm:px-6 lg:px-8 bg-cyan-400">
        ...
        <div id="news-list" class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 bg-cyan-200">
    ...
    <!-- Start of tabs -->
    <div class="mb-4 border-b border-gray-200 dark:border-gray-700 bg-cyan-400">
    ...
    <div id="default-tab-content bg-cyan-400">
